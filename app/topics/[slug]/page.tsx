                          ...
                          return (
                                          <div className="min-h-screen marble-bg flex items-center justify-center">
                                                  <div className="text-center">
                                                            ...
                                                            <p className="text-muted-foreground">Category not found</p>p>
                          ...
                          <div className="min-h-screen marble-bg pb-20 md:pb-0">
                                <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur-sm">
                                        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
                                                  ...
                                                  <div className="flex items-center gap-3">
                                                            {category.icon && <span className="text-2xl">{category.icon}</span>span>}
                                                              <div>
                                                                            <h1 className="text-lg font-bold text-foreground">{category.name_en}</h1>h1>
                                                                            <p className="text-xs text-muted-foreground">{hadiths.length} hadiths</p>p>
                                                              </div>div>
                                                  </div>div>
                                        </div>div>
                                </header>header>
                                ...
                                <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-6">
                                          {category.description && (
                                              <p className="text-sm text-muted-foreground leading-relaxed">{category.description}</p>p>
                                        )}
                                              ...
                                              <div className="flex flex-wrap gap-2">
                                                        ...
                                                        {tags.filter((t) => t.hadith_count > 0).map((tag) => (
                                                                      <button
                                                                                ...
                                                                                {tag.name_en}
                                                                                      <span className="text-[10px] opacity-60 ml-0.5">({tag.hadith_count})</span>span>
                                                                      </button>button>
                                                                    ))}
                                              </div>div>
                                        )}
                                          ...
                                          {hadiths.length === 0 ? (
                                              <div className="premium-card rounded-xl p-8 text-center">
                                                          ...
                                                          <p className="text-muted-foreground">No hadiths tagged in this category yet.</p>p>
                                              </div>div>
                                            ) : (
